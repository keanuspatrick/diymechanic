...
SWIFT_CLASS("_TtC25FirebaseMLModelDownloader19ModelFileDownloader")
@interface ModelFileDownloader : NSObject
...
@class NSURL;
@interface ModelFileDownloader (SWIFT_EXTENSION(FirebaseMLModelDownloader)) <NSURLSessionDownloadDelegate>
