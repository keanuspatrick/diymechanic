...
SWIFT_CLASS("_TtC15FirebaseStorage19StorageInternalTask") SWIFT_AVAILABILITY(watchos,introduced=7) SWIFT_AVAILABILITY(maccatalyst,introduced=13) SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(tvos,introduced=13) SWIFT_AVAILABILITY(ios,introduced=13)
@interface StorageInternalTask : FIRStorageTask
@end
...
@class NSURLRequest;
SWIFT_CLASS("_TtC15FirebaseStorage22StorageTokenAuthorizer") SWIFT_AVAILABILITY(watchos,introduced=7) SWIFT_AVAILABILITY(maccatalyst,introduced=13) SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(tvos,introduced=13) SWIFT_AVAILABILITY(ios,introduced=13)
@interface StorageTokenAuthorizer : NSObject <GTMSessionFetcherAuthorizer>
- (void)authorizeRequest:(NSMutableURLRequest * _Nullable)request completionHandler:(void (^ _Nonnull)(NSError * _Nullable))handler;
- (void)authorizeRequest:(NSMutableURLRequest * _Nullable)request delegate:(id _Nonnull)delegate didFinishSelector:(SEL _Nonnull)sel;
